...
import { FaPhone, FaLocationDot, FaYoutube, FaInstagram, FaFacebookF, FaLinkedinIn, FaTiktok } from "react-icons/fa6";
                ...
                <div className={styles.topSection}>
                    ...
                    <div className={styles.infoWrapper}>
                        ...
                        <div className={styles.infoCol}>
                            ...
                            <Link href="https://youtu.be/Ufj9hy-fdnU?is=-psLF3fItL7HAqdo" target="_blank" className={styles.contactItem}>
